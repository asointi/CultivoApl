...
alter PROCEDURE [dbo].[pbinv_registrar_item_cobol_version_5]
...
if(@empaque_principal = 0)
	...
	begin
		...
		insert into Item_Inventario_Preventa (id_cuenta_interna, id_inventario_preventa, id_tapa, id_variedad_flor, id_grado_flor, unidades_por_pieza, marca, id_tipo_caja, empaque_principal, controla_saldos, precio_minimo)
		values (@id_cuenta_interna, @id_inventario_preventa, @id_tapa, @id_variedad_flor, @id_grado_flor, @unidades_por_pieza, @marca, @id_tipo_caja, @empaque_principal, @controla_saldos, @precio_finca)
