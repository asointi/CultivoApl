...
alter PROCEDURE [dbo].[consultar_ordenes_pendientes_por_reportar_actuales]

as

declare @fecha_despacho_cultivo datetime,
...
tipo_factura.descripcion_tipo_factura,
idc_farm,
id_farm,
nombre_farm,
count(*) as cantidad into #pendientes_reportar
from #temp4, tipo_factura
...
/**/
select max(reporte_cambio_orden_pedido.fecha_transaccion) as fecha_reporte, 
max(reporte_cambio_orden_pedido.numero_reporte_farm) as numero_reporte_farm, 
reporte_cambio_orden_pedido.id_farm, 
reporte_cambio_orden_pedido.id_tipo_factura into #fechas
from reporte_cambio_orden_pedido, 
cuenta_interna
where reporte_cambio_orden_pedido.id_cuenta_interna = cuenta_interna.id_cuenta_interna
group by reporte_cambio_orden_pedido.id_farm, 
...
alter table #fechas
add nombre_cuenta nvarchar(255)

update #fechas
set nombre_cuenta = cuenta_interna.nombre
from reporte_cambio_orden_pedido, cuenta_interna
where reporte_cambio_orden_pedido.id_cuenta_interna = cuenta_interna.id_cuenta_interna
and #fechas.fecha_reporte = reporte_cambio_orden_pedido.fecha_transaccion

alter table #pendientes_reportar
add fecha_ultimo_reporte datetime, nombre_usuario nvarchar(255), numero_ultimo_reporte int

update #pendientes_reportar
set fecha_ultimo_reporte = #fechas.fecha_reporte,
nombre_usuario = #fechas.nombre_cuenta,
numero_ultimo_reporte = #fechas.numero_reporte_farm
from #pendientes_reportar, #fechas
where #pendientes_reportar.id_farm = #fechas.id_farm
and #pendientes_reportar.id_tipo_factura = #fechas.id_tipo_factura

select * from #pendientes_reportar

/*eliminación de tablas temporales*/
drop table #temp4
drop table #fechas
drop table #pendientes_reportar
drop table #wk
drop table #wk1
