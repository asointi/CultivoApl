...
alter PROCEDURE [dbo].[apr_ord_editar_confirmacion_orden_especial_cultivo]
...
begin
	...
	begin
		...
		select orden_pedido.id_orden_pedido, @id_confirmacion_orden_especial_cultivo
		from orden_pedido
	...
	begin
		...
		set @body1 ='Sent to Farm' + char(13) +
