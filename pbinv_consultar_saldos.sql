/****** Object:  StoredProcedure [dbo].[pbinv_consultar_saldos]    Script Date: 01/24/2008 08:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[pbinv_consultar_saldos]
...
id_variedad_flor,
id_grado_flor,
sum(cantidad_unidades_prebook_total) as cantidad_unidades_prebook_total into #prebook
from #temp 
where tipo_orden = 2
group by
id_farm,
...
update #temp
set prebook = #prebook.cantidad_unidades_prebook_total / #temp.unidades_por_pieza
from #temp, #prebook
