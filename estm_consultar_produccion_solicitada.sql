...
alter PROCEDURE [dbo].[estm_consultar_produccion_solicitada]
...
begin
	...
	select @id_descripcion_produccion_solicitada = max(id_descripcion_produccion_solicitada) 
...
if(@accion = 'consultar_cobol_version_2')
begin
	select ltrim(rtrim(tipo_flor.nombre_tipo_flor)) as nombre_tipo_flor,
	tipo_flor.idc_tipo_flor,
	ltrim(rtrim(variedad_flor.nombre_variedad_flor)) as nombre_variedad_flor,
	...
	tipo_pedido.idc_tipo_pedido + space(1) + '[' + nombre_tipo_pedido + ']' as nombre_tipo_pedido,
	bloque.id_bloque,
	bloque.idc_bloque,
	descripcion_produccion_solicitada.comentario,
	produccion_solicitada_rusia.fecha,
