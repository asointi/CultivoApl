...
create PROCEDURE [dbo].[apr_ord_crear_version_item_orden_sin_aprobar_version3] 
...
(
	...
	valor_pactado_cobol,
	observacion,
	porcentaje_ecuador_duty,
	precio_al_que_aplica
)
...
@body1 varchar(2048)
set @subject1 = 'Standing Order Pending Approval - Re-entered'
