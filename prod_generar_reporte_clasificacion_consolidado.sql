...
ALTER PROCEDURE [dbo].[prod_generar_reporte_clasificacion_consolidado]
...
begin
	select top 1 'Max. tallos mal clasificados' + space(1) + '(' +  convert(nvarchar,convert(decimal(20,1),porcentaje)) + '%' + ' - ' + 'Cant. tallos ' + convert(nvarchar,cantidad_tallos) + ')' + ' - ' + nombre_regla as subject, 
	porcentaje
	from #temp2
