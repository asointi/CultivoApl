...
alter PROCEDURE [dbo].[apr_ord_consultar_ordenes_canceladas]
...
aprobacion_orden.fecha_aprobacion as fecha_grabacion,
...
aprobacion_orden.observacion,
item_orden_sin_aprobar.precio_mercado,
item_orden_sin_aprobar.box_charges,
item_orden_sin_aprobar.observacion as observacion_procurement, 
isnull(item_orden_sin_aprobar.observacion, '') as observacion_procurement_vendedor into #temp
...
and aprobacion_orden.aceptada = 0
and not exists
(
	select *
...
farm.comision_farm,
isnull(item_orden_sin_aprobar.observacion, '')
having
...
farm.correo as correo_aprobacion,
solicitud_confirmacion_orden.observacion,
item_orden_sin_aprobar.precio_mercado,
item_orden_sin_aprobar.box_charges,
item_orden_sin_aprobar.observacion as observacion_procurement,
...
and solicitud_confirmacion_orden.aceptada = 0
...
item_orden_sin_aprobar.cantidad_piezas,
item_orden_sin_aprobar.valor_unitario,
confirmacion_orden_cultivo.fecha_grabacion,
convert(nvarchar,confirmacion_orden_cultivo.fecha_grabacion, 108),
...
farm.correo as correo_aprobacion,
confirmacion_orden_cultivo.observacion,
item_orden_sin_aprobar.precio_mercado,
item_orden_sin_aprobar.box_charges,
item_orden_sin_aprobar.observacion as observacion_procurement,
isnull(item_orden_sin_aprobar.observacion, '') as observacion_procurement_vendedor
...
solicitud_confirmacion_orden as sco,
confirmacion_orden_cultivo,
confirmacion_orden_cultivo as coc
where tipo_caja.id_tipo_caja = caja.id_tipo_caja
and ciudad.id_ciudad = farm.id_ciudad
and cliente_factura.id_cliente_factura = cliente_despacho.id_cliente_factura
and vendedor.id_vendedor = cliente_factura.id_vendedor
...
and confirmacion_orden_cultivo.id_confirmacion_orden_cultivo < = coc.id_confirmacion_orden_cultivo
and confirmacion_orden_cultivo.id_confirmacion_orden_cultivo_padre = coc.id_confirmacion_orden_cultivo_padre
and confirmacion_orden_cultivo.aceptada = 0
and not exists
(
	select *
	from orden_confirmada
	where confirmacion_orden_cultivo.id_confirmacion_orden_cultivo = orden_confirmada.id_confirmacion_orden_cultivo
)
group by
item_orden_sin_aprobar.id_item_orden_sin_aprobar_padre,
item_orden_sin_aprobar.id_item_orden_sin_aprobar,
...
farm.correo,
confirmacion_orden_cultivo.observacion,
confirmacion_orden_cultivo.id_confirmacion_orden_cultivo,
item_orden_sin_aprobar.precio_mercado,
item_orden_sin_aprobar.box_charges,
item_orden_sin_aprobar.observacion,
cliente_factura.id_cliente_factura,
...
and aprobacion_orden.id_aprobacion_orden = max(ao.id_aprobacion_orden)
and solicitud_confirmacion_orden.id_solicitud_confirmacion_orden = max(sco.id_solicitud_confirmacion_orden)
and confirmacion_orden_cultivo.id_confirmacion_orden_cultivo = max(coc.id_confirmacion_orden_cultivo)
