...
alter PROCEDURE [dbo].[na_editar_ramo_despatado_version_5]
...
begin
	...
	begin
		...
		begin
			insert into ramo_despatado (id_persona, idc_ramo_despatado, tallos_por_ramo, es_bouquet)
			select persona.id_persona, @idc_ramo, @tallos_por_ramo, @es_bouquet
			from persona
			where persona.idc_persona = @idc_persona
