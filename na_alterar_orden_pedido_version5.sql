...
create PROCEDURE [dbo].[na_alterar_orden_pedido_version5]
...
BEGIN TRANSACTION;
			...
			begin
				...
				begin
					...
					begin
						...
						id_transportador, id_tipo_factura, fecha_inicial, fecha_final, marca, unidades_por_pieza, cantidad_piezas, valor_unitario, disponible, id_vendedor, comida, upc, fecha_vencimiento_flor, fecha_creacion_orden, fecha_para_aprobar, numero_po)
	...
	exec	na_consulta_orden_pedido_llaveantofpv_proceso_automatico
			@idc_orden_pedido_ingresado = @idc_orden_pedido_padre_revision
	end
	else
	IF (@accion = 'borrar')
	begin
