alter PROCEDURE [dbo].[na_editar_factura_anulada]
...
begin
	begin try
		...
		insert into factura_anulada (idc_llave_factura, idc_numero_factura, fecha_factura, fecha_anulacion, comentario)
		values (@idc_llave_factura, @idc_numero_factura, @fecha_factura, dbo.concatenar_fecha_hora_COBOL(@fecha_anulacion, @hora_anulacion), @comentario)
