...
ALTER PROCEDURE [dbo].[preorden_consultar_orden_conjunta]
...
@id_temporada_año = temporada_año.id_temporada_año
from temporada,
año,
temporada_año,
temporada_cubo
...
null,--valor_unitario, 
@estado_inventario, 
sum(detalle_item_inventario_preventa.cantidad_piezas), 
null,
grado_flor.medidas,
color.idc_color,
color.prioridad_color,
