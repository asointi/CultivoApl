alter PROCEDURE [dbo].[na_generar_inventario]
...
set @nombre_grupo_cliente = 'BILL DORAN'
/***************************************************************/
...
pieza.marca as code,
estado_pieza.id_estado_pieza into #inventario
from pieza, 
tipo_flor,
variedad_flor,
grado_flor,
...
count(pieza.id_pieza) as cantidad_piezas into #mes_anterior_parcial
from factura, 
cliente_despacho,
item_factura,
...
------------------------------------------------
select tipo_flor.id_tipo_flor, 
count(pieza.id_pieza) as cantidad_piezas into #mes_anterior_total
from factura, 
item_factura,
detalle_item_factura,
pieza,
...
convert(int,ROUND( count(pieza.id_pieza)* (@porcentaje_maximo_inventario/100+1), 0))  as cantidad_piezas into #semana_anterior
from factura, 
cliente_despacho,
item_factura,
detalle_item_factura,
...
id_grado_flor, 
max(precio) as precio into #precio
from valor_producto 
...
idc_tipo_caja,
nombre_tipo_caja,
nombre_abreviado_tipo_caja as nombre_abreviado_tipo_caja,
idc_caja,
nombre_caja,
idc_color,
nombre_color,
unidades_por_pieza,
code,
convert(decimal(9,3),precio) as precio,
sum(piezas_total) as cantidad_piezas,
convert(decimal(20,4),(sum(factor_a_full)/sum(piezas_disponibles))) as fulls,
fuel into #floralship
from #inventario
group by 
idc_tipo_flor,
nombre_tipo_flor,
...
update #floralship
set cantidad_piezas = configuracion_bd.inv_tope_maximo_inventario
from configuracion_bd
where  cantidad_piezas > configuracion_bd.inv_tope_maximo_inventario
