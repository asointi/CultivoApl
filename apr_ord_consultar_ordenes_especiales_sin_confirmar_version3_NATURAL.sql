...
begin
	...
	isnull((
		...
		and cliente_factura.id_cliente_factura = #temp.id_cliente_factura
		), 0),
	Charges_per_unit = 
	(
	item_orden_sin_aprobar.box_charges +
	...
	Subtotal_3 = item_orden_sin_aprobar.valor_unitario - 
	(
	(
	item_orden_sin_aprobar.box_charges +
	isnull((
	...
	Comission = (item_orden_sin_aprobar.valor_unitario - 
	(
	(
	item_orden_sin_aprobar.box_charges +
	isnull((
	...
	) / item_orden_sin_aprobar.unidades_por_pieza)) * (farm.comision_farm / 100),
	Subtotal_5 = (item_orden_sin_aprobar.valor_unitario - 
	(
	(
	item_orden_sin_aprobar.box_charges +
	isnull((
	...
	) / item_orden_sin_aprobar.unidades_por_pieza)) - ((item_orden_sin_aprobar.valor_unitario - 
	(
	(
	item_orden_sin_aprobar.box_charges +
	isnull((
		...
		and cliente_factura.id_cliente_factura = recargo_tipo_cargo.id_cliente_factura
		and cliente_factura.id_cliente_factura = #temp.id_cliente_factura
		), 0)) / item_orden_sin_aprobar.unidades_por_pieza)) * (farm.comision_farm / 100)),
	...
	and cliente_factura.id_cliente_factura = recargo_tipo_cargo.id_cliente_factura
	and cliente_factura.id_cliente_factura = #temp.id_cliente_factura
	), 0) / item_orden_sin_aprobar.unidades_por_pieza
	),
	Subtotal_3 = item_orden_sin_aprobar.valor_unitario - 
	(
	isnull((
	...
	) - (ciudad.impuesto_por_caja * tipo_caja.factor_a_full) / item_orden_sin_aprobar.unidades_por_pieza
	from item_orden_sin_aprobar,
	orden_sin_aprobar,
	cliente_factura,
	cliente_despacho,
	...
	order by id_item_orden_sin_aprobar desc
