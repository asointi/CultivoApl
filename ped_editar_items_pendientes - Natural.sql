...
/*Esta version aplica unicamente para Natural*/
...
begin
	...
	ciudad.id_ciudad,
	datename(dw,[dbo].[calcular_dia_vuelo_preventa] (orden_pedido.fecha_inicial, farm.idc_farm)) as nombre_dia_despacho, 
	...
	item_reporte_cambio_orden_pedido.fecha_despacho_inicial,
	fecha_despacho_final,
	datename(dw,[dbo].[calcular_dia_vuelo_preventa] (item_reporte_cambio_orden_pedido.fecha_despacho_inicial, farm.idc_farm)) as nombre_dia_despacho,
