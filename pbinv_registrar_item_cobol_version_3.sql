...
alter PROCEDURE [dbo].[pbinv_registrar_item_cobol_version_3]
...
if(@empaque_principal = 0)
	...
	begin
		...
		values (@id_cuenta_interna, @id_inventario_preventa, @id_tapa, @id_variedad_flor, @id_grado_flor, @unidades_por_pieza, @marca, @id_tipo_caja, @empaque_principal)
