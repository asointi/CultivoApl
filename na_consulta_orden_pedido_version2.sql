...
alter PROCEDURE [dbo].[na_consulta_orden_pedido_version2]
...
alter table #temp
add id_transportador_anterior int,
idc_transportador_anterior nvarchar(255)

select max(id_historia_transportador_orden_pedido) as id_historia_transportador_orden_pedido,
id_orden_pedido into #transportador_anterior
from historia_transportador_orden_pedido
group by id_orden_pedido

update #temp 
set id_transportador_anterior = historia_transportador_orden_pedido.id_transportador
from historia_transportador_orden_pedido,
#transportador_anterior
where #temp.id_orden_pedido = #transportador_anterior.id_orden_pedido
and #transportador_anterior.id_historia_transportador_orden_pedido = historia_transportador_orden_pedido.id_historia_transportador_orden_pedido

update #temp
set idc_transportador_anterior = transportador.idc_transportador
from transportador
where #temp.id_transportador_anterior = transportador.id_transportador
...
drop table #temp
drop table #temp2
drop table #transportador_anterior
drop table #ordenes