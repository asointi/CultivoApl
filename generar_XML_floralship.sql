...
GO
ALTER PROCEDURE [dbo].[generar_XML_floralship]
...
0 as pricec,
0 as packing1,
sum(piezas_total) as csrec,
0 as cswhole,
0 as cssold,
0 as cshold,
left(convert(nvarchar,getdate(),126),19)+'-04:00' as daterec,
0 as bunch,
'' as packed,
ltrim(rtrim(nombre_grado_flor)) as grade,
ltrim(rtrim(nombre_variedad_flor)) as variety,
ltrim(rtrim(nombre_color)) as color,
idc_tipo_flor as cat,
ltrim(rtrim(nombre_tipo_flor)) as flowertype,
