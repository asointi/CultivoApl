--alter table cliente_despacho
--add delivery_fuel_surcharge decimal(20,4),
--delivery_piece_fee decimal(20,4)

set ANSI_NULLS ON
set QUOTED_IDENTIFIER ON
go

create PROCEDURE [dbo].[na_insertar_actualizar_cliente_version4]
...
@delivery_fuel_surcharge Decimal(20,4),
@delivery_piece_fee Decimal(20,4)
...
begin
	...
	begin
		...
		delivery_fuel_surcharge = @delivery_fuel_surcharge,
		delivery_piece_fee = @delivery_piece_fee,
