...
alter PROCEDURE [dbo].[pbinv_consultar_saldos_factura_por_cliente_transportador_version3]
...
id_tapa,
precio_minimo,
controla_saldos into #empaque_principal
from #temp
where tipo_orden = '1'
and empaque_principal = 1
group by id_farm,
id_variedad_flor,
id_grado_flor,
id_tapa,
