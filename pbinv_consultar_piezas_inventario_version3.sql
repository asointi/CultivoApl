...
alter PROCEDURE [dbo].[pbinv_consultar_piezas_inventario_version3]
...
select isnull(@unidades_inventario, 0) as unidades_inventario,
isnull(@unidades_prevendidas, 0) as unidades_prevendidas,
