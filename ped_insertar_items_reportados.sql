...
ALTER PROCEDURE [dbo].[ped_insertar_items_reportados]
...
declare @numero_reporte_farm integer, 
@id_reporte_cambio_orden_pedido integer, 
@id_reporte_cambio_orden_pedido_doble integer, 
@conteo integer, 
@conteo_doble integer, 
@dias_atras integer, 
...
begin
	...
	if(@conteo <> 0)
	begin
		select @numero_reporte_farm = max(numero_reporte_farm)+1 from Reporte_Cambio_Orden_Pedido where id_farm = @id_farm and id_tipo_factura = @id_tipo_factura
		if (@numero_reporte_farm is null)
		begin
			set @numero_reporte_farm = 1
		end
		
		insert into Reporte_Cambio_Orden_Pedido (id_farm,id_cuenta_interna,id_tipo_factura,fecha_despacho_inicial_consultada,numero_reporte_farm, comentario)
		select @id_farm,@id_cuenta_interna,@id_tipo_factura,@fecha_despacho_cultivo,@numero_reporte_farm,@comentario
		...
		id_despacho,
		id_vendedor
		from #temp4 order by disponible
...
begin
	...
	where disponible = 1
	and not exists
	(select #temp2_pb.id_orden_pedido
	from #temp_pb
	...
	begin
		...
		insert into Reporte_Cambio_Orden_Pedido (id_farm, id_cuenta_interna, id_tipo_factura, fecha_despacho_inicial_consultada, numero_reporte_farm, comentario, id_temporada_año)
		select @id_farm, @id_cuenta_interna, @id_tipo_factura, @fecha_despacho_cultivo, @numero_reporte_farm, @comentario, @id_temporada_año
		...
		insert into Reporte_Cambio_Orden_Pedido (id_farm, id_cuenta_interna, id_tipo_factura, fecha_despacho_inicial_consultada, numero_reporte_farm, comentario, id_temporada_año)
		select @id_farm, @id_cuenta_interna, @id_tipo_factura_doble, @fecha_despacho_cultivo, @numero_reporte_farm, @comentario, @id_temporada_año
		...
		id_vendedor
		from #temp4_pb 
		where id_tipo_factura = @id_tipo_factura_doble
		order by disponible
	end
