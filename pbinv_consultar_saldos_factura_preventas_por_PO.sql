USE [BD_Fresca]
GO
/****** Object:  StoredProcedure [dbo].[pbinv_consultar_saldos_factura_preventas_por_PO]    Script Date: 1/22/2015 10:25:27 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[pbinv_consultar_saldos_factura_preventas_por_PO]
...
id_grado_flor,
id_tapa,
max(convert(int,controla_saldos)) as controla_saldos,
max(precio_minimo) as precio_minimo into #empaque_principal
from #temp
