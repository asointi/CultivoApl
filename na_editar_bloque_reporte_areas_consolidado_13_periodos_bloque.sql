...
alter PROCEDURE [dbo].[na_editar_bloque_reporte_areas_consolidado_13_periodos_bloque]
...
cantidad_tallo_bloque int,
area_bloque decimal(20,4),
promedio_bloque decimal(20,4)
...
#bloques.id_variedad_flor,
#bloques.idc_variedad_flor,
#bloques.nombre_variedad_flor,
#temp.periodo, 
#temp.rango_fechas,
#bloques.idc_bloque,
#bloques.id_tipo_flor,
#bloques.idc_tipo_flor,
#bloques.nombre_tipo_flor,
...
and #camas_sembradas_definitivas.id_variedad_flor = #temp.id_variedad_flor
...
(
	...
	and #temp.id_variedad_flor = #faltante.id_variedad_flor
	and #temp.id_tipo_flor = #faltante.id_tipo_flor
...
update #temp
set area_por_cama = 0
where #temp.area_por_cama is null
...
case
	when  sum(area_por_cama) = 0 then null
	else sum(cantidad_tallos) / sum(area_por_cama)
end as promedio into #promedio_bloque
from #temp
group by id_bloque,
periodo

update #temp
set cantidad_tallo_bloque = #promedio_bloque.cantidad_tallos,
area_bloque = #promedio_bloque.area,
promedio_bloque = #promedio_bloque.promedio
from #promedio_bloque
where #promedio_bloque.id_bloque = #temp.id_bloque
and #promedio_bloque.periodo = #temp.periodo
